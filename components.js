...
function initHeaderDropdown() {
  ...
  if (threeDotsBtn && dropdownMenu) {
    threeDotsBtn.addEventListener('click', (e) => {
      e.stopPropagation();
      // Close analytics dropdown if open
      if (analyticsDropdown) analyticsDropdown.classList.remove('active');
      dropdownMenu.classList.toggle('active');
    });
  }

  // Analytics 2x2 grid dropdown
  if (analyticsBtn && analyticsDropdown) {
    analyticsBtn.addEventListener('click', (e) => {
      e.stopPropagation();
      // Close three dots dropdown if open
